...
const text = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit! Proin efficitur at justo ut volutpat?';
            ...
            <main className="flex-1 flex items-center justify-center">
                <div className="text-white p-4 rounded-lg mb-24 w-fit flex flex-col items-center justify-center space-y-6">
                    ...
                    <div className="flex flex-col space-y-2 w-fit">
                        <Link to="/signup"> 
                            <MainButton textSize='text-xl' width="w-[19rem]">Empezar</MainButton>
                        </Link>
                        <Link to="/login">
                            <SecondaryButton textSize='text-xl'>Ya tengo una cuenta</SecondaryButton>
                        </Link>
                    </div>
                </div>
            </main>
